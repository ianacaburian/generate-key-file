...
static auto
divideBy(
    juce::String const &dividendHexParam, juce::String const &divisorHexParam
) noexcept {
...
main() {
    ...
    auto const [dividendHex, divisorHex, quotientHex, remainderHex] =
        divideBy(dividendHexParam, divisorHexParam);
